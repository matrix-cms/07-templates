...
newLink: function (prnt, action)
{
	...
	{
		case "expand":
			new_image.setAttribute('src', 'https://www.unimelb.edu.au/template-assets/07/images/menu/plus.gif');
		...
		break;
		case "collapse":
			new_image.setAttribute('src', 'https://www.unimelb.edu.au/template-assets/07/images/menu/minus.gif');
