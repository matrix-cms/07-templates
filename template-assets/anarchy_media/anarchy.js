...
var anarchy_url = 'http://www.unimelb.edu.au/template-assets/anarchy_media' // http address for the anarchy-media folder (no trailing slash).
var accepted_domains=new Array("unimelb.edu.au") 	// OPTIONAL - Restrict script use to your domains. Add root domain name (minus 'http' or 'www') in quotes, add extra domains in quotes and separated by comma.
